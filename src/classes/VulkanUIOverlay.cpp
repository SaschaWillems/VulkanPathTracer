...
namespace vks 
{
	UIOverlay::UIOverlay()
	{
		...
		const ImVec4 vulkanRed = ImVec4(164.0f/255.0f, 30.0f/255.0f, 34.0f/255.0f, 1.0f);
		style.Colors[ImGuiCol_TitleBg] = vulkanRed;
		style.Colors[ImGuiCol_TitleBgActive] = vulkanRed;
		style.Colors[ImGuiCol_TitleBgCollapsed] = vulkanRed;
